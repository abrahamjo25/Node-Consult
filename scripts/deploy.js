...
async function main() {
  try {
        ...
        //     remoteRoot: "ftps://waws-prod-am2-689.ftp.azurewebsites.windows.net/site/wwwroot", // Upload location on remote, replace with subfolder on FTP-server if required
